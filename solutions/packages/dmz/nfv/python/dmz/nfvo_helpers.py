...
class VNFError (RuntimeError):
    ...
    def __init__(self, tenant, deployment_name, esc):
        ...
        super(VNFError, self).__init__(msg)
...
class NSError (RuntimeError):
    ...
    def __init__(self, ns_name):
        ...
        super(NSError, self).__init__(msg)
...
def is_vnf_ready(tctx, tenant, deployment_name, esc):
    ...
    with maapi.single_read_trans(tctx.username, "system",
        ...
        vnf_deployment = oroot.nfvo_rel2__nfvo.vnf_info.nfvo_rel2_esc__esc.vnf_deployment
...
def _vnf_devices(th, tenant, deployment_name, esc):
    ...
    res = oroot.nfvo_rel2__nfvo.vnf_info.\
          nfvo_rel2_esc__esc.vnf_deployment_result[tenant,
                                    deployment_name,
                                    esc]
